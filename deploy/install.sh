...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/gghyoo/sub2api-plus/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="gghyoo/sub2api-plus"
...
Documentation=https://github.com/gghyoo/sub2api-plus
