...
curl -sSL https://raw.githubusercontent.com/gghyoo/sub2api-plus/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/gghyoo/sub2api-plus/releases)
