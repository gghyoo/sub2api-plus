  ...
  admin: {
    ...
    settings: {
      ...
      site: {
        ...
        modelsGuide: 'Models Guide Tip',
        modelsGuidePlaceholder: 'Enter the tip content displayed below the models table. Supports Markdown & HTML. Leave empty to hide.',
        modelsGuideHint: 'Displayed as a blue info card below the models pricing table on the homepage. Use Markdown or HTML to write model selection tips, usage scenarios, etc.',
